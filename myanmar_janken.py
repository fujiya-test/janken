...
# ミャンマーのじゃんけん: ဆင် (ゾウ) vs လူ (人) vs ပုရွက်ဆိတ် (アリ)
# ゾウ→人に勝つ、人→アリに勝つ、アリ→ゾウに勝つ

def get_hand_name(hand_index):
    hands = ["ဆင် (ゾウ)", "လူ (人)", "ပုရွက်ဆိတ် (アリ)"]
    return hands[hand_index]

def play_round():
    print("\n0: ဆင် (ゾウ), 1: လူ (人), 2: ပုရွက်ဆိတ် (アリ)")
    try:
...
def janken():
    print("ミャンマーのじゃんけんをしましょう！")
    print("（ゾウは人に勝つ、人はアリに勝つ、アリはゾウに勝つ）")
    print("1: 通常モード (1回勝負)")
    print("2: さんまモード (3回先取)")
